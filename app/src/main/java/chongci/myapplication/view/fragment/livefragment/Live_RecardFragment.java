...
public class Live_RecardFragment extends BaseFragment {
    ...
    protected void initData() {
        String url="http://api.cntv.cn/video/videolistById?vsid=VSET100340574858&n=7&serviceId=panda&o=desc&of=time&p="+page;
