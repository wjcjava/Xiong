...
public class Live_OriginalFragment extends BaseFragment {
    ...
    protected void initData() {
        String url="http://api.cntv.cn/video/videolistById?vsid=VSET100219009515&n=7&serviceId=panda&o=desc&of=time&p="+page;
