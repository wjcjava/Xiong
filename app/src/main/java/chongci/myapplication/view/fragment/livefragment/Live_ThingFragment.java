...
public class Live_ThingFragment extends BaseFragment {
    ...
    protected void initData() {
        String url="http://api.cntv.cn/video/videolistById?vsid=VSET100237714751&n=7&serviceId=panda&o=desc&of=time&p="+page;
