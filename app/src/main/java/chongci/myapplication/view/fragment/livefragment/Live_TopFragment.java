...
public class Live_TopFragment extends BaseFragment {
    ...
    protected void initData() {
        String url="http://api.cntv.cn/video/videolistById?vsid=VSET100284428835&n=7&serviceId=panda&o=desc&of=time&p="+page;
